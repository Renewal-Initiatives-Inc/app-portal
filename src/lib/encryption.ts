 ...
 */
export function encrypt(plaintext: string, keyEnvVar = 'PAYROLL_ENCRYPTION_KEY'): string {
 ...
 */
export function decrypt(encrypted: string, keyEnvVar = 'PAYROLL_ENCRYPTION_KEY'): string {
  const key = getKeyFromEnv(keyEnvVar)
...
// --- Employee PII helpers ---

const PAYROLL_KEY = 'PAYROLL_ENCRYPTION_KEY'

export function encryptPII(plaintext: string): string {
  return encrypt(plaintext, PAYROLL_KEY)
}

export function decryptPII(encrypted: string): string {
  return decrypt(encrypted, PAYROLL_KEY)
}
